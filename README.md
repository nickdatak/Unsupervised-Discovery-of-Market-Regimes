...
**Paper:** [Google Doc](https://docs.google.com/document/d/1km77DliO0iUhR27PnQhj4Wr7PHCjOJrApaH4D3TrPp4/edit?usp=sharing) · PDF in [`paper/`](paper/)
...
| [`notebooks/evaluation & comparison /`](notebooks/evaluation%20%26%20comparison%20/) | Comparison metrics, causal robustness, external validation |
| [`paper/`](paper/) | Working paper PDF |
| [`INTERVIEW_CRIB_SHEET.md`](INTERVIEW_CRIB_SHEET.md) | Internal summary of audit findings and talking points |

Primary analysis notebooks:

- [`regime_comparison_analysis.ipynb`](notebooks/evaluation%20%26%20comparison%20/regime_comparison_analysis.ipynb) — durations, transitions, ARI, drawdowns
- [`causal_robustness_analysis.ipynb`](notebooks/evaluation%20%26%20comparison%20/causal_robustness_analysis.ipynb) — filtered HMM vs Viterbi; expanding z-score
- [`external_validation.ipynb`](notebooks/evaluation%20%26%20comparison%20/external_validation.ipynb) — NBER recessions, VIX-threshold baseline

---

## Citation

If you use this code or results, please cite the SSRN working paper linked from the paper directory and note that headline persistence numbers depend on HMM decoding choice (Viterbi vs filtered).
